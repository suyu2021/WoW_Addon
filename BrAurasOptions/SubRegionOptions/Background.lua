...
do
  ...
  BrAuras.RegisterSubRegionOptions("subbackground", subCreateOptions, L["Background"]);
end
...
do
  ...
  BrAuras.RegisterSubRegionOptions("subforeground", subCreateOptions, L["Foreground"]);
end
