...
local L = BrAuras.L;
local GetAtlasInfo = BrAuras.IsClassicEra() and GetAtlasInfo or C_Texture.GetAtlasInfo
...
local function createOptions(id, data)
  ...
  -- v2.6.2.2: hide "Progress Settings" (progress source/min/max) for simplified BanruoUI usage.
  -- Keep position & size settings intact.
  return {
...
local function createIcon()
  local data = {
    foregroundTexture = "Interface\\Addons\\BrAuras\\PowerAurasMedia\\Auras\\Aura3",
    backgroundTexture = "Interface\\Addons\\BrAuras\\PowerAurasMedia\\Auras\\Aura3",
    sameTexture = true,
    backgroundOffset = 2,
    blendMode = "BLEND",
    width = 200,
