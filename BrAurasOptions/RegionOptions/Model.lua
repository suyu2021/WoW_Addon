...
local function createOptions(id, data)
  local options = {
    ...
    modelIsUnit = {
      ...
      order = 0.5,
      hidden = function() return data.modelDisplayInfo and BrAuras.BuildInfo > 80100 end
    },
    modelDisplayInfo = {
      type = "toggle",
      width = BrAuras.normalWidth,
    ...
    chooseModel = {
      ...
      disabled = function() return data.modelIsUnit or (BrAuras.BuildInfo > 80100 and data.modelDisplayInfo) end,
      imageWidth = 24,
      imageHeight = 24,
      control = "BrAurasIcon",
...
local function modifyThumbnail(parent, region, data)
  ...
  BrAuras.SetModel(model, nil, data.model_fileId, data.modelIsUnit, data.modelDisplayInfo)
