...
local function createOptions(id, data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(options, data, L["Custom Function"], "customText", "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#custom-text",
