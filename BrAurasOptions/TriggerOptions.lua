...
local function GetGlobalOptions(data)
  ...
  OptionsPrivate.commonOptions.AddCodeOption(globalTriggerOptions, data, L["Custom"], "custom_trigger_combination", "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#custom-activation",
...
function OptionsPrivate.AddTriggerMetaFunctions(options, data, triggernum)
  ...
  options.__delete = {
    ...
    func = function(...)
      ...
      if canDelete then
        StaticPopupDialogs["BRAURAS_CONFIRM_TRIGGER_DELETE"] = {
        ...
        StaticPopup_Show("BRAURAS_CONFIRM_TRIGGER_DELETE")
      end
    end
  }
  if (C_AddOns.GetAddOnEnableState("BrAurasTemplates") ~= Enum.AddOnEnableState.None) then
