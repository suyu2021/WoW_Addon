...
local function addControlsForChange(args, order, data, conditionVariable, totalAuraCount, conditions, i, j, allProperties, usedProperties)
      ...
      elseif (property == "DELETE") then
        if (data.controlledChildren) then
          for id, reference in pairs(conditions[i].changes[j].references) do
            local auraData = BrAuras.GetData(id);
  ...
  if (propertyType == "bool" or propertyType == "number") then
    ...
    if (propertyType == "number") then
      ...
      if (properties.min or properties.softMin) and (properties.max or properties.softMax) then
        ...
        args["condition" .. i .. "value" .. j].control = "BrAurasSpinBox"
        ...
        args["condition" .. i .. "value" .. j].validate = BrAuras.ValidateNumeric;
      end
    else
  ...
  elseif (propertyType == "string" or propertyType == "texture") then
    ...
    if propertyType == "texture" then
      args["condition" .. i .. "value" .. j].width =  BrAuras.normalWidth - 0.15
  ...
  elseif (propertyType == "list" or propertyType == "progressSource" or propertyType == "textureLSM") then
    ...
    if propertyType == "progressSource" then
      args["condition" .. i .. "value" .. j].control = "BrAurasTwoColumnDropdown"
  ...
  elseif (propertyType == "chat") then
    ...
    args["condition" .. i .. "value" .. j .. "message dest_text_replacements_button"] = {
      ...
      imageHeight = 24,
      control = "BrAurasIcon",
      image = "Interface\\AddOns\\BrAuras\\Media\\Textures\\sidebar",
    }
    order = order + 1;
    ...
    args["condition" .. i .. "value" .. j .. "custom"] = {
      ...
      control = "BrAurasMultiLineEditBox",
        ...
        extraFunctions = {
          {
            ...
            func = function()
              if (data.controlledChildren) then
                ...
                OptionsPrivate.OpenTextEditor(data, multipath, nil, true, nil, nil, "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#chat-message---custom-code-1");
              else
                OptionsPrivate.OpenTextEditor(data, {"conditions", i, "changes", j, "value", "custom"}, nil, nil, nil, nil, "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#chat-message---custom-code-1");
              end
            end
          }
        }
        ...
        extraFunctions = {
          {
            ...
            func = function()
              if (data.controlledChildren) then
                ...
                OptionsPrivate.OpenTextEditor(data, multipath, true, true, nil, nil, "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#run-custom-code");
              else
                data.conditions[i].changes[j].value = data.conditions[i].changes[j].value or {};
                OptionsPrivate.OpenTextEditor(data, {"conditions", i, "changes", j, "value", "custom"}, true, nil, nil, nil, "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#run-custom-code");
              end
            end
          }
        }
...
local function addControlsForIfLine(args, order, data, conditionVariable, totalAuraCount, conditions, i, path, conditionTemplates, conditionTemplateWithoutCombinations, allProperties, parentType)
  ...
  local normalWidth = BrAuras.normalWidth - indentWidth;
  ...
  if (indentWidth > 0) then
    ...
    args["condition" .. i .. tostring(path) .. "bullet"] = {
      ...
      name = "",
      order = order,
      image = "Interface\\Addons\\BrAuras\\Media\\Textures\\bullet" .. indentDepth,
      imageWidth = 10,
      imageHeight = 10,
    }
    order = order + 1;
      ...
      if (conditionTemplatesToUse.indexToTrigger[v] == "REMOVE") then
        if (data.controlledChildren) then
          for id, reference in pairs(conditions[i].check.references) do
            ...
            BrAuras.Add(auraData)
            BrAuras.ClearAndUpdateOptions(auraData.id)
          end
        else
          ...
          extraFunctions = {
            {
              ...
              func = function()
                if (data.controlledChildren) then
                  ...
                  OptionsPrivate.OpenTextEditor(data, multipath, nil, true, nil, nil, "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#custom-check");
                else
                  ...
                  OptionsPrivate.OpenTextEditor(data, fullPath, nil, nil, nil, nil, "https://github.com/BrAuras/BrAuras2/wiki/Custom-Code-Blocks#custom-check");
                end
              end
            }
          }
...
local function addControlsForCondition(args, order, data, conditionVariable, totalAuraCount, conditions, i, conditionTemplates, conditionTemplateWithoutCombinations, allProperties)
  ...
  args["condition" .. i .. "header"] = {
    ...
    image = collapsed and "Interface\\AddOns\\BrAuras\\Media\\Textures\\expand" or "Interface\\AddOns\\BrAuras\\Media\\Textures\\collapse" ,
    imageWidth = 18,
    imageHeight = 18,
    control = "BrAurasExpand",
  ...
  args["condition" .. i .. "up"] = {
    ...
    width = 0.15,
    image = "Interface\\AddOns\\BrAuras\\Media\\Textures\\moveup",
    imageWidth = 24,
    imageHeight = 24,
    control = "BrAurasIcon"
  };
  ...
  args["condition" .. i .. "down"] = {
    ...
    width = 0.15,
    image = "Interface\\AddOns\\BrAuras\\Media\\Textures\\movedown",
    imageWidth = 24,
    imageHeight = 24,
    control = "BrAurasIcon"
  };
  ...
  args["condition" .. i .. "duplicate"] = {
    ...
    width = 0.15,
    image = "Interface\\AddOns\\BrAuras\\Media\\Textures\\duplicate",
    imageWidth = 24,
    imageHeight = 24,
    control = "BrAurasIcon"
  };
