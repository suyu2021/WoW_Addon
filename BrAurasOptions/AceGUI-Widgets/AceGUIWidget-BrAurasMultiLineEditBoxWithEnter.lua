...
local Type, Version = "BrAuras-MultiLineEditBoxWithEnter", 2
...
if not AceGUIBrAurasMultiLineEditBoxWithEnterInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIBrAurasMultiLineEditBoxWithEnterInsertLink(...) end)
end

function _G.AceGUIBrAurasMultiLineEditBoxWithEnterInsertLink(text)
