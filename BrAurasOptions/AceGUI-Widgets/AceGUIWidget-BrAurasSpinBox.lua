...
Spin Box Widget
-------------------------------------------------------------------------------]]
local Type, Version = "BrAurasSpinBox", 5
...
local progressLeftOffset = BrAuras.IsClassicOrWrathOrCata() and -2 or -3
local progressExtraWidth = BrAuras.IsClassicOrWrathOrCata() and -2 or 0
local progressTopOffset = BrAuras.IsClassicOrWrathOrCata() and -3 or -2
local progressBottomOffset = BrAuras.IsClassicOrWrathOrCata() and 3 or 2
...
local function Constructor()
  ...
  leftbutton:SetSize(16, 16)
	leftbutton:SetNormalTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxleft")
  leftbutton:SetHighlightTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxlefth")
	leftbutton:SetPushedTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxleftp")
	leftbutton:SetDisabledTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxleftp")
  leftbutton:SetScript("OnClick", SpinBox_OnValueDown)

  local rightbutton = CreateFrame("Button", nil, frame)
  rightbutton:SetSize(16, 16)
	rightbutton:SetNormalTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxright")
  rightbutton:SetHighlightTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxrighth")
	rightbutton:SetPushedTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxrightp")
	rightbutton:SetDisabledTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxrightp")
  ...
  progressBar:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\spinboxoverlay")
  ...
  progressBarHandleTexture:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_White")
