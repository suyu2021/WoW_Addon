...
local Type, Version = "BrAurasExpandSmall", 4
...
local methods = {
  ...
  ["SetImage"] = function(self, path, ...)
    ...
    if path == "collapsed" then
      ...
      path = "Interface\\AddOns\\BrAuras\\Media\\Textures\\gear"
    elseif path == "expanded" then
      self:SetExpandedState(true)
      path = "Interface\\AddOns\\BrAuras\\Media\\Textures\\geardown"
    else
      self:SetExpandedState(false)
    end
...
local function Constructor()
  ...
  highlight:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_White")
  ...
  expandedHighlight:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_White")
  ...
  expandedBackground:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_AlphaGradient")
