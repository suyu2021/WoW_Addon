...
local Type, Version = "BrAurasInputWithIndentation", 2
...
if not AceGUIBrAurasInputWithIndentationInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIBrAurasInputWithIndentationInsertLink(...) end)
end

function _G.AceGUIBrAurasInputWithIndentationInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("BrAurasInputWithIndentation%uEdit"):format(i)]
...
local function Constructor()
  ...
  local editbox = CreateFrame("EditBox", string.format("BrAurasInputWithIndentation%uEdit", format(num)), frame, "InputBoxTemplate")
