...
local Type, Version = "BrAurasAnchorButtons", 2
...
local function Constructor()
  local name = "BrAurasAnchorButtons" .. AceGUI:GetNextWidgetNum(Type)
  ...
  background:SetBackdrop({
     bgFile = "Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_FullWhite.tga",
     edgeFile = "Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_FullWhite.tga",
     tile = true,
     tileEdge = true,
     --tileSize = 8,
     edgeSize = 2
  ...
  for _, direction in ipairs(directions) do
    ...
    buttonTex:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_FullWhite.tga")
