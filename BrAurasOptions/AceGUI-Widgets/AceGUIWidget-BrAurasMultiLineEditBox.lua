...
local Type, Version = "BrAurasMultiLineEditBox", 39
...
if not AceGUIBrAurasMultiLineEditBoxInsertLink then
  -- upgradeable hook
  hooksecurefunc("ChatEdit_InsertLink", function(...) return _G.AceGUIBrAurasMultiLineEditBoxInsertLink(...) end)
end

function _G.AceGUIBrAurasMultiLineEditBoxInsertLink(text)
  for i = 1, AceGUI:GetWidgetCount(Type) do
    local editbox = _G[("BrAurasMultiLineEditBox%uEdit"):format(i)]
