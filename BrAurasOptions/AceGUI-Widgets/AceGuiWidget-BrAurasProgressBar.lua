...
-------------------------------------------------------------------------------]]
local Type, Version = "BrAurasProgressBar", 2
...
local function Constructor()
  ...
  foreground:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_White")
  background:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_White")
