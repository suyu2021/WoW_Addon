...
local Type, Version = "BrAurasPendingInstallButton", 3
...
local methods = {
  ...
  ["Initialize"] = function(self, id, companionData)
    ...
    function self.callbacks.OnUpdateClick()
      BrAuras.Import(self.companionData.encoded)
    end
...
local function Constructor()
  local name = "BrAurasPendingInstallButton" .. AceGUI:GetNextWidgetNum(Type)
