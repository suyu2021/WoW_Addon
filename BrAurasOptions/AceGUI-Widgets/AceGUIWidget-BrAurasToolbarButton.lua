...
Graphical Button.
-------------------------------------------------------------------------------]]
local Type, Version = "BrAurasToolbarButton", 7
...
local function Constructor()
	...
	hTex:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_FullWhite")
	...
	pTex:SetTexture("Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_FullWhite")
