...
local function ConstructModelPicker(frame)
  ...
  local filterInput = CreateFrame("EditBox", "BrAurasFilterInput", group.frame, "SearchBoxTemplate")
  ...
  local modelTree = AceGUI:Create("BrAurasTreeGroup");
  ...
  modelTree:SetTree(BrAuras.ModelPaths);
  ...
  function group.PickSt(self, model_fileId, model_tx, model_ty, model_tz, model_rx, model_ry, model_rz, model_us)
    ...
    BrAuras.SetModel(self.model, nil, self.selectedValues.model_fileId)
