...
Enable this setting if you want this timer to be hidden, or when using a BrAuras text to display the timer]=] ] = [=[A timer will automatically be displayed according to default Interface Settings (overridden by some addons).
Enable this setting if you want this timer to be hidden, or when using a BrAuras text to display the timer]=]
...
Off Screen]=] ] = "Aura está fora da tela"
	...
	L["Chat with BrAuras experts on our Discord server."] = "Converso com especialistas do BrAuras no nosso servidor do Discord."
...
Since this is a status-type trigger, the specified events may be called by BrAuras without the expected arguments.
...
every 3 events starting from 2nd and ending at 11th: 2-11/3]=]
	...
	--[[Translation missing --]]
	L["Requires LibSpecialization, that is e.g. a up-to date BrAuras version"] = "Requires LibSpecialization, that is e.g. a up-to date BrAuras version"
	--[[Translation missing --]]
	...
	--[[Translation missing --]]
	L["The BrAuras Options Addon version %s doesn't match the BrAuras version %s. If you updated the addon while the game was running, try restarting World of Warcraft. Otherwise try reinstalling BrAuras"] = "The BrAuras Options Addon version %s doesn't match the BrAuras version %s. If you updated the addon while the game was running, try restarting World of Warcraft. Otherwise try reinstalling BrAuras"
	L["Then "] = "Então"
	--[[Translation missing --]]
...
It might not work correctly!]=]
	--[[Translation missing --]]
	L[ [=[This aura was created with a newer version of BrAuras.
Upgrade your version of BrAuras or wait for next release before installing this aura.]=] ] = [=[This aura was created with a newer version of BrAuras.
Upgrade your version of BrAuras or wait for next release before installing this aura.]=]
	--[[Translation missing --]]
	...
	L["We thank"] = "We thank"
	--[[Translation missing --]]
	L["BrAuras %s on WoW %s"] = "BrAuras %s on WoW %s"
	--[[Translation missing --]]
	L["BrAuras recommends using spell ids instead of names. Spell ids are automatically localized."] = "BrAuras recommends using spell ids instead of names. Spell ids are automatically localized."
	--[[Translation missing --]]
...
Would you like to continue?]=]
	--[[Translation missing --]]
	L[ [=[You can add a comma-separated list of state values here that (when changed) BrAuras should also run the Anchor Code on.

BrAuras will always run custom anchor code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=] ] = [=[You can add a comma-separated list of state values here that (when changed) BrAuras should also run the Anchor Code on.

BrAuras will always run custom anchor code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=]
	--[[Translation missing --]]
	L[ [=[You can add a comma-separated list of state values here that (when changed) BrAuras should also run the Grow Code on.

BrAuras will always run custom grow code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=] ] = [=[You can add a comma-separated list of state values here that (when changed) BrAuras should also run the Grow Code on.

BrAuras will always run custom grow code if you include 'changed' in this list, or when a region is added, removed, or re-ordered.]=]
	--[[Translation missing --]]
	L["You can add a comma-separated list of state values here that (when changed) BrAuras should also run the sort code on.BrAuras will always run custom sort code if you include 'changed' in this list, or when a region is added, removed."] = "You can add a comma-separated list of state values here that (when changed) BrAuras should also run the sort code on.BrAuras will always run custom sort code if you include 'changed' in this list, or when a region is added, removed."
	--[[Translation missing --]]
