...
Off Screen]=]
	...
	--[[Translation missing --]]
	L["Chat with BrAuras experts on our Discord server."] = "Chat with BrAuras experts on our Discord server."
...
Da es sich um einen Zustands-Auslöser handelt, kann es passieren, dass BrAuras nicht die in der WoW-API spezifizierten Argumente übergibt.
