...
https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000La prise en charge des événements COMBAT_LOG_EVENT_UNFILTERED non filtrés est obsolète|r Les événements COMBAT_LOG_EVENT_UNFILTERED sans filtre sont désactivés, car ils nuisent fortement aux performances. Plus d'informations : https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[A detailed overview of your auras and BrAuras systems
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=[Cannot change secure frame in combat lockdown. Find more information:
...
L["Copper"] = "Copper"
--[[Translation missing --]]
L["Could not load BrAuras Archive, the addon is %s"] = "Could not load BrAuras Archive, the addon is %s"
L["Count"] = "Nombre"
...
L["Malformed BrAuras link"] = "Lien BrAuras mal formé"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
L["Using BrAuras.clones is deprecated. Use BrAuras.GetRegion(id, cloneId) instead."] = "L'utilisation de BrAuras.clones est obsolète. Utilisez plutôt BrAuras.GetRegion(id, cloneId)."
L["Using BrAuras.regions is deprecated. Use BrAuras.GetRegion(id) instead."] = "L'utilisation de BrAuras.regions est obsolète. Utilisez plutôt BrAuras.GetRegion(id)."
