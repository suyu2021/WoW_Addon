...
https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트의 지원은 중단됐습니다|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 성능 소모가 심해 사용할 수 없습니다. 자세한 정보: https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = [=[당신의 위크오라와 BrAuras 시스템 전반에 대한 상세 정보입니다
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=[전투 중에는 보안 프레임을 변경할 수 없습니다. 자세한 정보:
...
L["Copper"] = "코퍼"
L["Could not load BrAuras Archive, the addon is %s"] = "BrAuras Archive를 불러올 수 없습니다. 애드온이 %s 상태입니다"
L["Count"] = "개수"
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=['%s' 오류가 보안 요소의 복사본을 생성했습니다. 이 위크오라는 삭제할 것을 권장합니다. 자세한 정보:
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=]
L["Error decoding."] = "디코딩 오류입니다."
L["Error decompressing"] = "압축 해제 오류"
L["Error decompressing. This doesn't look like a BrAuras import."] = "압축을 푸는 중 오류가 발생했습니다. BrAuras 가져오기 문자열이 아닙니다."
...
L["Malformed BrAuras link"] = "잘못된 BrAuras 링크"
L["Manual"] = "수동 설정"
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=[보안 프레임이 감지됐습니다. 자세한 정보:
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=]
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the BrAuras Discord server for help."] = "이 필터는 위치 활성 조건으로 이전됐습니다. 새로운 위치 활성 조건을 사용하려면 위크오라를 수정하시고 잘 모르겠으면 BrAuras Discord 서버에 접속해서 도움을 요청하세요."
...
L["True"] = "참"
L["Trying to repair broken conditions in %s likely caused by a BrAuras bug."] = "%s에서 BrAuras 버그로 인해 망가진 조건 복구를 시도중입니다."
L["Twin Emperors"] = "쌍둥이 제왕"
L["Type"] = "종류"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to the BrAuras team."] = "'%s' 위크오라를 현대화할 수 없습니다. 데이터 오염이나 마이그레이션에 문제가 있는 것 같습니다. 이 내역을 BrAuras 팀에 제보해 주세요."
...
L["Using BrAuras.clones is deprecated. Use BrAuras.GetRegion(id, cloneId) instead."] = "BrAuras.clones는 더이상 사용할 수 없습니다. BrAuras.GetRegion(id, cloneId)를 사용하세요."
L["Using BrAuras.regions is deprecated. Use BrAuras.GetRegion(id) instead."] = "BrAuras.regions는 더이상 사용할 수 없습니다. BrAuras.GetRegion(id)를 사용하세요."
...
L["BrAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "BrAuras 내장 (63:42 | 3:07 | 10 | 2.4)"
L["BrAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/weakauras."] = "BrAuras가 빈 설정을 감지했습니다. 갑자기 발생한 것이라면 https://discord.gg/weakauras에서 도움을 요청하세요."
L[ [=[BrAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[BrAuras가 다운그레이드를 감지했습니다.
...
L["Writing to the BrAuras table is not allowed."] = "BrAuras 테이블에 작성하는 행위는 허용되지 않습니다."
L["X-Offset"] = "X-위치 조정"
L["Yell"] = "외침"
L["Y-Offset"] = "Y-위치 조정"
