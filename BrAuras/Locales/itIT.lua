...
https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events]=] ] = [=[|cFFFF0000Support for unfiltered COMBAT_LOG_EVENT_UNFILTERED is deprecated|r
COMBAT_LOG_EVENT_UNFILTERED without a filter are disabled as it’s very performance costly.
Find more information:
...
L[ [=[A detailed overview of your auras and BrAuras systems
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "Una panoramica dettagliata delle tue aure e dei sistemi BrAuras, Copia l'intero testo su Discord di Weakaura se hai bisogno di assistenza."
--[[Translation missing --]]
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = "Non è possibile modificare il frame protetto durante il blocco del combattimento. Trova ulteriori informazioni: https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames"
...
--[[Translation missing --]]
L["Copper"] = "Copper"
L["Could not load BrAuras Archive, the addon is %s"] = "Impossibile caricare l'archivio BrAuras, il componente aggiuntivo è %s"
L["Count"] = "Conteggio "
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=[Error '%s' created a secure clone. We advise deleting the aura. For more information:
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=]
--[[Translation missing --]]
L["Error decoding."] = "Error decoding."
--[[Translation missing --]]
L["Error decompressing"] = "Error decompressing"
--[[Translation missing --]]
L["Error decompressing. This doesn't look like a BrAuras import."] = "Error decompressing. This doesn't look like a BrAuras import."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Malformed BrAuras link"] = "Malformed BrAuras link"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=[Secure frame detected. Find more information:
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=]
--[[Translation missing --]]
...
--[[Translation missing --]]
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the BrAuras Discord server for help."] = "This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the BrAuras Discord server for help."
--[[Translation missing --]]
...
L["True"] = "True"
--[[Translation missing --]]
L["Trying to repair broken conditions in %s likely caused by a BrAuras bug."] = "Trying to repair broken conditions in %s likely caused by a BrAuras bug."
--[[Translation missing --]]
L["Twin Emperors"] = "Twin Emperors"
--[[Translation missing --]]
L["Type"] = "Type"
--[[Translation missing --]]
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to the BrAuras team."] = "Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to the BrAuras team."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Using BrAuras.clones is deprecated. Use BrAuras.GetRegion(id, cloneId) instead."] = "Using BrAuras.clones is deprecated. Use BrAuras.GetRegion(id, cloneId) instead."
--[[Translation missing --]]
L["Using BrAuras.regions is deprecated. Use BrAuras.GetRegion(id) instead."] = "Using BrAuras.regions is deprecated. Use BrAuras.GetRegion(id) instead."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["BrAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "BrAuras Built-In (63:42 | 3:07 | 10 | 2.4)"
--[[Translation missing --]]
L["BrAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/weakauras."] = "BrAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/weakauras."
--[[Translation missing --]]
L[ [=[BrAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[BrAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s
...
--[[Translation missing --]]
L["BrAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "BrAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."
--[[Translation missing --]]
L["BrAuras Profiling"] = "BrAuras Profiling"
--[[Translation missing --]]
L["BrAuras Profiling Report"] = "BrAuras Profiling Report"
--[[Translation missing --]]
L["BrAuras Version: %s"] = "BrAuras Version: %s"
--[[Translation missing --]]
L["Weapon"] = "Weapon"
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Writing to the BrAuras table is not allowed."] = "Writing to the BrAuras table is not allowed."
--[[Translation missing --]]
L["X-Offset"] = "X-Offset"
--[[Translation missing --]]
L["Yell"] = "Yell"
