...
https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000Поддержка нефильтрованного COMBAT_LOG_EVENT_UNFILTERED устарела|r COMBAT_LOG_EVENT_UNFILTERED без фильтра отключены, так как это очень затратно по производительности. Подробнее: https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "Подробный обзор Ваших аур и систем BrAuras. Скопируйте весь текст в Discord Weakaura, если Вам нужна помощь."
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = "Невозможно изменить защищённый кадр во время боя. Подробная информация на странице: https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames"
...
L["Copper"] = "Медь"
L["Could not load BrAuras Archive, the addon is %s"] = "Не удалось загрузить BrAuras Archive. Причина - %s"
L["Count"] = "Количество"
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = "Ошибка при возвращении в пул клона индикации %s, поскольку кадр защищён. Советуем удалить эту индикацию. Подробная информация на странице: https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames"
L["Error decoding."] = "Ошибка декодирования"
L["Error decompressing"] = "Ошибка распаковки"
L["Error decompressing. This doesn't look like a BrAuras import."] = "Ошибка распаковки. Это не похоже на строку импорта BrAuras"
...
L["Malformed BrAuras link"] = "Неверная ссылка BrAuras"
L["Manual"] = "Ручной"
...
L["Options could not be loaded, the addon is %s"] = "Не удалось загрузить BrAuras Options. Причина - %s"
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = [=[Обнаружен защищённый кадр. Подробная информация на странице:
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the BrAuras Discord server for help."] = "Этот фильтр был перенесен в триггер Местоположение. Измените вашу ауру, чтобы использовать новый триггер Местоположение, или присоединяйтесь к серверу Discord BrAuras для получения помощи."
...
L["True"] = "Истина"
L["Trying to repair broken conditions in %s likely caused by a BrAuras bug."] = "Попытка восстановить поврежденные условия в индикации %s, причиной которых стала ошибка аддона."
L["Twin Emperors"] = "Императоры-близнецы"
L["Type"] = "Тип"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to the BrAuras team."] = "Невозможно модернизировать ауру '%s'. Вероятно, это связано с повреждением данных или неудачным перемещением. Сообщите об этом команде BrAuras."
...
L["Using BrAuras.clones is deprecated. Use BrAuras.GetRegion(id, cloneId) instead."] = "BrAuras.clones объявлено устаревшим. Используйте функцию BrAuras.GetRegion(id, cloneId)."
L["Using BrAuras.regions is deprecated. Use BrAuras.GetRegion(id) instead."] = "BrAuras.regions объявлено устаревшим. Используйте функцию BrAuras.GetRegion(id)."
...
L["BrAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "BrAuras (встроенный):  63:42 | 3:07 | 10 | 2.4"
L["BrAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/weakauras."] = "BrAuras обнаружил пустые настройки. Если это произошло неожиданно, обратитесь за помощью на https://discord.gg/weakauras."
L[ [=[BrAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = [=[BrAuras обнаружил, что версия аддона была понижена (осуществлен downgrade). Ваши индикации могут перестать работать должным образом.
...
L["Writing to the BrAuras table is not allowed."] = "Запись в таблицу BrAuras запрещена."
