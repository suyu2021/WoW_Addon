...
https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000El soporte para COMBAT_LOG_EVENT_UNFILTERED sin filtro está obsoleto|r COMBAT_LOG_EVENT_UNFILTERED sin un filtro están deshabilitados ya que son muy costosos en términos de rendimiento. Más información: https://github.com/BrAuras/BrAuras2/wiki/Custom-Triggers#events"
...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "Una descripción detallada de tus sistemas de auras y BrAuras. Copia todo el texto en el Discord de WeakAura si necesitas ayuda."
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = "No se puede cambiar el marco de seguridad en el bloqueo de combate. Más información: https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames"
...
L["Copper"] = "Cobre"
L["Could not load BrAuras Archive, the addon is %s"] = "No se pudo cargar BrAuras Archive, el addon está %s"
L["Count"] = "Recuento"
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = "El error '%s' ha creado un clon seguro. Aconsejamos eliminar el aura. Para más información: https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames"
L["Error decoding."] = "Error al descodificar."
L["Error decompressing"] = "Error al descomprimir"
L["Error decompressing. This doesn't look like a BrAuras import."] = "Error al descomprimir. Esto no parece una importación de BrAuras."
...
L["Malformed BrAuras link"] = "Enlace BrAuras malformado"
L["Manual"] = "Manual"
...
https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames]=] ] = "Marco seguro detectado. Encuentra más información: https://github.com/BrAuras/BrAuras2/wiki/Protected-Frames"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the BrAuras Discord server for help."] = "Este filtro ha sido trasladado al disparador de ubicación. Cambia tu aura para utilizar el nuevo disparador de ubicación o únete al servidor de Discord de BrAuras para obtener ayuda."
...
L["True"] = "Verdadero"
L["Trying to repair broken conditions in %s likely caused by a BrAuras bug."] = "Intentando reparar condiciones rotas en %s probablemente causadas por un error de BrAuras."
L["Twin Emperors"] = "Emperadores gemelos"
L["Type"] = "Tipo"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration, please report this to the BrAuras team."] = "No se puede modernizar el aura '%s'. Probablemente se deba a datos corruptos o una migración incorrecta. Por favor, informe de esto al equipo de BrAuras."
...
L["Using BrAuras.clones is deprecated. Use BrAuras.GetRegion(id, cloneId) instead."] = [=[El uso de BrAuras.clones está en desuso. Utilice BrAuras.GetRegion(id, cloneId) en su lugar.
]=]
L["Using BrAuras.regions is deprecated. Use BrAuras.GetRegion(id) instead."] = "El uso de BrAuras.regions está en desuso. Utilice BrAuras.GetRegion(id) en su lugar."
...
​]=]
L["BrAuras Built-In (63:42 | 3:07 | 10 | 2.4)"] = "BrAuras incorporado (63:42 | 3:07 | 10 | 2.4)"
L["BrAuras has detected empty settings. If this is unexpected, ask for assitance on https://discord.gg/weakauras."] = "BrAuras ha detectado configuraciones vacías. Si esto es inesperado, solicita asistencia en https://discord.gg/weakauras."
L[ [=[BrAuras has detected that it has been downgraded.
Your saved auras may no longer work properly.
Would you like to run the |cffff0000EXPERIMENTAL|r repair tool? This will overwrite any changes you have made since the last database upgrade.
Last upgrade: %s

|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = "BrAuras ha detectado que ha sido degradado. Es posible que tus auras guardadas ya no funcionen correctamente. ¿Te gustarías ejecutar la herramienta de reparación |cffff0000EXPERIMENTAL|r? Esto sobrescribirá cualquier cambio que haya realizado desde la última actualización de la base de datos. Última actualización: %s |cffff0000Debes HACER UNA COPIA DE SEGURIDAD de tu carpeta WTF ANTES de presionar este botón.|r"
L["BrAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "BrAuras está creando una instantánea de reversión de tus auras. Esta instantánea te permitirá volver al estado actual de tus auras si algo sale mal. Este proceso puede hacer que tu tasa de fotogramas disminuya hasta que se complete."
L["BrAuras Profiling"] = "Perfilado de BrAuras"
L["BrAuras Profiling Report"] = "Informe de perfilado de BrAuras"
L["BrAuras Version: %s"] = "BrAuras Versión: %s"
L["Weapon"] = "Arma"
...
L["Writing to the BrAuras table is not allowed."] = "No se permite escribir en la tabla BrAuras."
