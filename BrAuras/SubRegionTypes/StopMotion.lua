...
local default = function(parentType)
  local defaults = {
    ...
    stopmotionTexture = "Interface\\AddOns\\BrAuras\\Media\\Textures\\stopmotion",
  ...
  if C_AddOns.IsAddOnLoaded("BrAurasStopMotion") then
    defaults.stopmotionTexture = "Interface\\AddOns\\BrAurasStopMotion\\Textures\\IconOverlays\\ArcReactor"
...
BrAuras.RegisterSubRegionType("substopmotion", L["Stop Motion"], supports, create, modify, onAcquire, onRelease, default, nil, properties)
