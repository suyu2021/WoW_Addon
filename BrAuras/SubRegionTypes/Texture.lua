...
local default = function(parentType)
  local defaults = {
    ...
    textureTexture = "Interface\\Addons\\BrAuras\\PowerAurasMedia\\Auras\\Aura3",
...
BrAuras.RegisterSubRegionType("subtexture", L["Texture"], supports, create, modify, onAcquire, onRelease, default, nil, properties)
