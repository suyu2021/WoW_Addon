...
local default = function(parentType)
  local defaults = {
    ...
    linearTextureTexture = "Interface\\AddOns\\BrAuras\\Media\\Textures\\Square_FullWhite",
...
BrAuras.RegisterSubRegionType("sublineartexture", L["Linear Texture"], supports, create, modify, onAcquire, onRelease,
