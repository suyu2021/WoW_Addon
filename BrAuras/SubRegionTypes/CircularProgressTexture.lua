...
local default = function(parentType)
  local defaults = {
    ...
    circularTextureTexture = "Interface\\AddOns\\BrAuras\\Media\\Textures\\square_border_5px.tga",
...
BrAuras.RegisterSubRegionType("subcirculartexture", L["Circular Texture"], supports, create, modify, onAcquire, onRelease,
